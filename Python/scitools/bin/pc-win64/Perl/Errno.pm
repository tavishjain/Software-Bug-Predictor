...
"MSWin32-x64-multi-thread-10.0.18363.900" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.18363.900) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEBADF WSAENAMETOOLONG WSAESTALE WSAEADDRNOTAVAIL WSAENOTCONN
	WSAENOMORE WSAEINVAL WSAENOTEMPTY WSAEUSERS WSAEDQUOT
	WSAEINVALIDPROVIDER WSAENOTSOCK WSAETOOMANYREFS WSAECONNREFUSED
	WSAEHOSTDOWN WSAESOCKTNOSUPPORT WSAEINVALIDPROCTABLE WSAESHUTDOWN
	WSAECONNABORTED WSAEOPNOTSUPP WSAEDESTADDRREQ WSAEFAULT
	WSAEAFNOSUPPORT WSAENETRESET WSAECONNRESET WSAETIMEDOUT WSAEADDRINUSE
	WSAEPROTONOSUPPORT WSAEPROTOTYPE WSAENETDOWN WSAEDISCON
	WSAEHOSTUNREACH WSAEREMOTE WSAEINTR WSAEPROCLIM WSAECANCELLED
	WSAEISCONN WSAEMSGSIZE WSAEPFNOSUPPORT WSAENETUNREACH
	WSAEPROVIDERFAILEDINIT WSAEACCES WSAEALREADY WSAEREFUSED WSAEMFILE
	WSAEWOULDBLOCK WSAELOOP WSAENOPROTOOPT WSAEINPROGRESS
	WSAENOBUFS
    )],
);
